...
const RentalRequestList = () => {
  ...
  const fetchRequests = async () => {
    try {
      const endpoint = user.userType === 'landlord'
        ? `${apiUrl}/api/rental-requests/received-requests`
        : `${apiUrl}/api/rental-requests/my-requests`;
  ...
  const handleApprove = async (requestId) => {
    try {
      const response = await fetch(`${apiUrl}/api/rental-requests/${requestId}/approve`, {
        method: 'PATCH',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`
        }
  ...
  const handleReject = async (requestId) => {
    ...
    try {
      const response = await fetch(`${apiUrl}/api/rental-requests/${requestId}/reject`, {
        method: 'PATCH',
        headers: {
