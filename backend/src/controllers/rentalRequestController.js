...
exports.createRentalRequest = catchAsync(async (req, res, next) => {
  ...
  sendNotification(req.app, {
    ...
    message: `${req.user.name} solicitou o aluguel do imóvel "${property.title}"`,
    relatedEntity: rentalRequest._id,
...
exports.approveRequest = catchAsync(async (req, res, next) => {
  ...
  await request.populate('property', 'title');
  sendNotification(req.app, {
    recipientId: request.tenant,
    senderId: req.user._id,
    type: 'rental_approved',
    title: 'Solicitação aprovada!',
    message: `A sua solicitação para o imóvel "${request.property?.title}" foi aprovada.`,
...
exports.rejectRequest = catchAsync(async (req, res, next) => {
  ...
  sendNotification(req.app, {
    ...
    message: `A sua solicitação para o imóvel "${request.property?.title}" foi rejeitada.`,
    relatedEntity: request._id,
    relatedEntityType: 'Rental'
  });
