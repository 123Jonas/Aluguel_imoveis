...
router.post('/properties', propertyController.uploadImages, propertyController.processImages, propertyController.createProperty);
router.get('/properties/:id', landlordController.getProperty);
router.patch('/properties/:id', propertyController.uploadImages, propertyController.processImages, propertyController.updateProperty);
